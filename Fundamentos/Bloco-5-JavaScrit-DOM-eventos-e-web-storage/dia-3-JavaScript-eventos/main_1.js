...
function rClick() {
  for (i = 0; i < list.length; i += 1) {
    let tech = document.getElementsByTagName('li')[i];
    tech.classList.remove('tech');
    tech.classList.add('tech');
    input.value = '';
  }
}
firstLi.addEventListener('click', rClick);
...
function myPortfolio(){
  window.location.replace('https://cassidhorimi.github.io/cassid-horimi-portfolio');
}
